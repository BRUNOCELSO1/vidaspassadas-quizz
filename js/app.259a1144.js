    ...
    var e = {
            7615: function(e, n, t) {
                var r = t(6848),
                    ...
                    a = u,
                    c = t(1656),
                    f = (0, c.A)(a, o, i, !1, null, null, null),
                    l = f.exports,
                    d = t(6178);
                r.Ay.use(d.Ay);
                var s = new d.Ay({
                    ...
                    routes: [{
                        path: "/enviodosdados",
                        name: "HelloWorld",
                        component: () => Promise.all([t.e(355), t.e(875)]).then(t.bind(t, 4246)),
                        props: !0
                    }, {
                        path: "/pGwZSDj",
                        name: "PaginaPrincipal",
                        component: () => t.e(233).then(t.bind(t, 7379)),
                        props: !0
                    }, {
                        path: "/",
                        name: "KirvanoUpsellVideov2",
                        component: () => Promise.all([t.e(355), t.e(752)]).then(t.bind(t, 6099)),
                        props: !1
                    }]
                });
                r.Ay.config.productionTip = !1, new r.Ay({
                    router: s,
                    render: e => e(l)
                }).$mount("#app")
            }
    ...
    t.m = e,
        ...
        function() {
            ...
            t.l = function(r, o, i, u) {
                if (e[r]) e[r].push(o);
                    ...
                    a || (c = !0, a = document.createElement("script"), a.charset = "utf-8", a.timeout = 120, t.nc && a.setAttribute("nonce", t.nc), a.setAttribute("data-webpack", n + i), a.src = r), e[r] = [o];
                    var s = function(n, t) {
        ...
        function() {
            if ("undefined" !== typeof document) {
                var e = function(e, n, r, o, i) {
                        ...
                        u.rel = "stylesheet", u.type = "text/css", t.nc && (u.nonce = t.nc);
                        var a = function(t) {
                            if (u.onerror = u.onload = null, "load" === t.type) o();
                            else {
                                var r = t && t.type,
                                    a = t && t.target && t.target.href || n,
                                    c = new Error("Loading CSS chunk " + e + " failed.\n(" + r + ": " + a + ")");
                                c.name = "ChunkLoadError", c.code = "CSS_CHUNK_LOAD_FAILED", c.type = r, c.request = a, u.parentNode && u.parentNode.removeChild(u), i(c)
                            }
                        };
                        return u.onerror = u.onload = a, u.href = n, r ? r.parentNode.insertBefore(u, r.nextSibling) : document.head.appendChild(u), u
                    },
                    n = function(e, n) {
        ...
        function() {
            ...
            var n = function(n, r) {
                ...
                r = self["webpackChunknumerologia"] = self["webpackChunknumerologia"] || [];
...
//# sourceMappingURL=app.259a1144.js.map